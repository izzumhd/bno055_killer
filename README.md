...
> **Note**: the default IMU is **LSM6DS3** and the default Magnetometer is **QMC5883L** and it works well with it. I haven't tested this library with either **HMC5883L** or **BMI160** or **MPU6050** yet. So if you want to use any of them, I would appreciate it if you test it yourself and let me know if it works. Thanks!
